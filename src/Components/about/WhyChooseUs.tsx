      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-20">
        ...
        >
          ...
          <p className="text-slate-500 mt-3 max-w-md mx-auto text-[15px]">
            Everything we do is built around quality, trust, and your satisfaction.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                {/* Tag pill */}
                <span className={`self-start text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full ${feature.bgIcon} ${feature.iconColor} mb-4`}>
                  {feature.tag}
                </span>

                {/* Icon */}
                <div className={`w-14 h-14 ${feature.bgIcon} rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300`}>
                  <Icon className={`w-6 h-6 ${feature.iconColor}`} />
                </div>
                ...
                <div className="pt-4 border-t border-slate-100 text-center">
                  <p className={`text-lg font-extrabold ${feature.iconColor}`}>{feature.stat}</p>
                  <p className="text-xs text-slate-400 mt-0.5">{feature.statLabel}</p>
                </div>
              </div>
            );
          })}
