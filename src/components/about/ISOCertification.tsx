...
const highlights = [
  { icon: ShieldCheck, text: 'Quality Management Systems', color: 'text-blue-600', bg: 'bg-blue-50' },
  { icon: CheckCircle2, text: 'Consistent Product Quality', color: 'text-emerald-600', bg: 'bg-emerald-50' },
  { icon: FileCheck, text: 'Continuous Improvement', color: 'text-amber-600', bg: 'bg-amber-50' },
];
          ...
          <div className="relative flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            >
              <div className="relative w-44 h-44 lg:w-52 lg:h-52 rounded-full bg-amber-50 border-2 border-amber-200 flex flex-col items-center justify-center">
                ...
                <span className="font-bold text-2xl lg:text-3xl text-slate-800 leading-none">ISO</span>
                <span className="font-bold text-lg text-amber-500 leading-tight">9001:2015</span>
                <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mt-1">Certified</span>
              </div>
            </div>
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                ...
                management systems. Every batch of paint undergoes rigorous testing and quality
                checks to meet international standards — giving you products you can trust.
              </p>
